#!/usr/bin/env python3
"""Validate diffusion_models/metadata/evidence.json against the seeded schema.
...
7. Every paper_id resolves in diffusion_models/metadata/papers.json
...
PAPER_META_FILE = ROOT / "diffusion_models" / "metadata" / "papers.json"
