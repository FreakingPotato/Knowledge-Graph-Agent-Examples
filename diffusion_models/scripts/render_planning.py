...
``diffusion_models/metadata/planning_evidence.json``.
...
Usage::
    ...
    python diffusion_models/scripts/render_planning.py
    python diffusion_models/scripts/render_planning.py --force
    python diffusion_models/scripts/render_planning.py --next-step <id>
"""
...
META_DIR = ROOT / "diffusion_models" / "metadata"
...
def _process_paper_for_next_step(
    ...
    *,
    ...
    for idx, group in enumerate(groups, start=1):
        ...
        rendered.append({
            "href": f"diffusion_models/assets/evidence/{png_name}",
            "page": page_idx + 1,
...
def main(argv: list[str] | None = None) -> int:
    ...
    payload = {
        "schema_version": "0.1",
        "topic": "diffusion_models_planning",
