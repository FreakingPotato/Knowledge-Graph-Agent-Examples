...
``ai_agents/metadata/evidence.json``. Cross-domain = physics, chemistry,
...
* ``ai_agents/metadata/papers.json`` -- paper registry (MMG-NNN)
* ``ai_agents/metadata/candidates.json`` -- candidates per claim
* ``ai_agents/metadata/discovery_log.json`` -- per-claim diagnostics
