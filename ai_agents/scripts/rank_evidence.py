#!/usr/bin/env python3
"""Rank evidence points within each claim of ai_agents/metadata/evidence.json.
...
WCM_FILE = ROOT / "ai_agents" / "metadata" / "papers.json"
EXT_FILE = ROOT / "ai_agents" / "metadata" / "papers.json"
DEFAULT_LOG = ROOT / "ai_agents" / "metadata" / "rank_log.md"
